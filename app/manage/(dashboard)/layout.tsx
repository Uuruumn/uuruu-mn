    ...
    <div style={{ background: '#0f172a', minHeight: '100vh', color: '#f8fafc' }}>
      <header style={{
        ...
        <div className="container" style={{
          ...
          justifyContent: 'space-between', minHeight: 64, gap: 12
        }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
            <span style={{
              background: '#c9a227', color: '#0f172a', fontWeight: 800,
              padding: '4px 10px', borderRadius: 8, fontSize: '0.75rem', letterSpacing: '0.1em'
            }}>ADMIN</span>
            <strong style={{ fontSize: '1rem', color: '#f8fafc' }}>Uuruu.mn</strong>
          </div>
          <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
            <Link href="/" style={{
              color: '#94a3b8', fontSize: '0.85rem', padding: '7px 12px',
